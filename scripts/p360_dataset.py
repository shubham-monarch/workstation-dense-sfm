...
class P360DatasetGenerator:
    ...
    def __init__(self, 
        ...
        # extracting the images, points3D and cameras from the model
        #$self.sfm_images_dict = self.sfm_model.images
        #self.sfm_points3D_dict = self.sfm_model.points3D
        ...
        self.pcl_path = os.path('path/to/sfm/pointcloud')
        self.segmentation_path = os.path('path/to/segmentation')
        self.image_path = os.path('path/to/images')
        self.camera_params = os.path('path/to/camera_params')
        self.camera_pose_path = os.path('path/to/camera_pose')
    
        self.indices = self.generate_indices()
        self.pcl = o3d.io.read_point_cloud(self.pcl_path)
        '''
