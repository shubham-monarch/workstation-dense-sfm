			...
			for file in files:
				...
				try:
					...
					if file_exists and not overwrite:
						logging.info(f"Skipping {local_path} as it already exists in S3")
						skipped_counst += 1
					else:
...
if __name__ == "__main__":
	...
	parser.add_argument('--root', type=str,  required = True, help='Prefix for S3 folder')
	...
	flag =  upload_folder_to_s3(local_folder, bucket_name, s3_folder)
